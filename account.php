...
<title>Educhamp Computerised Ability Test </title>
...
$qw=mysqli_query($con,"SELECT * FROM quiz WHERE  eid='$eid' " )or die('Error157');
while($row=mysqli_fetch_array($qw) ){
$title=$row['title'];
   echo' <tr style="color:#66CCFF"><td>You have Attempted&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td>'.$title.'</td></tr>';
}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">9643427377</h4>
		<h4 style="font-family:'typo' ">vivek2227gupta@gmail.com</h4>
		<h4 style="font-family:'typo' ">Maharaja Surajmal insitute of Technology </h4></div></div>
		</p>
      </div>
