  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/WIN_20180103_13_27_44_Pro" width=100 height=100 alt="Vivek Gupta" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://www.google.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Yugesh Verma</a>
		...
		<h4 style="font-family:'typo' ">Maharaja Surajmal Institute Of Technology</h4></div></div>
		</p>
      </div>
